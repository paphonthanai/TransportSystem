    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
      <div>
        ...
        <div class="text-xs text-muted mt-0.5">
          เลือกงานขนส่งที่ส่งเสร็จแล้ว (DELIVERED) ของลูกค้ารายเดียวกัน เพื่อออกใบเสร็จรับเงินทันที — ใช้เมื่อรับเงินแล้วจริง (เช่น ลูกค้าที่ไม่ต้องออกใบกำกับภาษี หรือรับเงินสดหน้างาน)
        </div>
      </div>
...
const submit = () => {
  ...
  const result = salesDocumentsStore.createReceiptFromBookings(orderedIds, { contactId: contactId.value })
