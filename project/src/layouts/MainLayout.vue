...
const getScreenTitle = () => {
  const routes: Record<string, string> = {
    ...
    '/receipts/new-manual': 'สร้างใบเสร็จรับเงิน',
  ...
  if (currentRoute.path.startsWith('/payroll/drivers/documents/')) return 'พนักงานขับรถ · พิมพ์เอกสารรายได้'
  if (currentRoute.path.startsWith('/settings/drivers/')) return 'รายละเอียดพนักงานขับรถ'
  if (currentRoute.path.startsWith('/payroll/vendor-fleet/documents/')) return 'รถร่วม · พิมพ์เอกสารรายได้'
